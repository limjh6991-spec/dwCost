...
const grid = {
  ...
  columns: [
    ...
    { name: 'GLASS_THICK', fieldName: 'glassThick', width: '80', header: { text: '두께' }, autoFilter: true, styleName: 'tr', styleCallback: addNewRow('tr') },
    { name: 'SHEET', fieldName: 'sheet', width: '80', header: { text: 'SHEET' }, autoFilter: true, styleName: 'tr', styleCallback: addNewRow('tr') },
