...
const grid = {
  ...
  fields: [
    ...
    { fieldName: '배부율', dataType: ValueType.TEXT },
  ...
  { name: 'expen_sel', fieldName: 'expenSel', width: '80', header: { text: '원가항목코드' }, autoFilter: true, styleName: 'tl',  },
  { name: 'expen_sel명', fieldName: 'expenSel명', width: '80', header: { text: '원가항목명' }, autoFilter: true, styleName: 'tl',  },
  { name: 'mat_class', fieldName: 'matClass', width: '80', header: { text: '대분류' }, autoFilter: true, styleName: 'tl',  },
  { name: '환산량', fieldName: '환산량', width: '80', header: { text: '환산량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.0',},
  { name: '소요량', fieldName: '소요량', width: '80', header: { text: '소요량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0', } ,
  { name: '면적', fieldName: '면적', width: '80', header: { text: '면적' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.000000', },
  { name: '배부적수', fieldName: '배부적수', width: '80', header: { text: '배부적수' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0', },
  { name: '배부율', fieldName: '배부율', width: '80', header: { text: '배부율' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0',  },
