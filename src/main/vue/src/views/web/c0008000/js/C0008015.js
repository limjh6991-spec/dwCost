...
const grid = {
  ...
  columns: [
    ...
    { name: 'distRate', fieldName: 'distRate', width: '80', header: { text: '배부율' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.0000', },
    { name: 'subName', fieldName: 'subName', width: '80', header: { text: '대분류' }, autoFilter: true, styleName: 'tl' },
    ...
    { name: 'expenSel명', fieldName: 'expenSel명', width: '80', header: { text: 'EXPEN_NAME' }, autoFilter: true, styleName: 'tl' },
