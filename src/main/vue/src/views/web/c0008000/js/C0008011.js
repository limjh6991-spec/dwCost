...
const grid = {
  ...
  columns: [
    ...
    { name: '판매금액계', fieldName: '판매금액계', width: '150', header: { text: '판매금액계' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.##', footer: { expression: 'sum', numberFormat: '#,##0.##', styleName: 'sum-footer1' } },
