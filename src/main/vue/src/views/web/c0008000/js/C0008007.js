...
const grid = {
  ...
  columns: [
    ...
    { name: '구분', fieldName: '구분', width: '40', header: { text: '구분' }, autoFilter: true, styleName: 'tl', },
    { name: '도우모델', fieldName: '도우모델', width: '80', header: { text: '모델명' }, autoFilter: true, styleName: 'tl', },
