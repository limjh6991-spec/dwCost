...
const grid = {
  ...
  fields: [
    ...
    { fieldName: 'matLclass', dataType: ValueType.TEXT },
  ...
  columns: [
    ...
    { name: 'matDesc', fieldName: 'matDesc', width: '80', header: { text: '자재명' }, autoFilter: true, styleName: 'tl', },
    { name: 'matLclass', fieldName: 'matLclass', width: '80', header: { text: '자재대분류' }, autoFilter: true, styleName: 'tl', },
    ...
    { name: 'unit', fieldName: 'unit', width: '80', header: { text: '단위' }, autoFilter: true, styleName: 'tl', footer: { text: '합계' } },
