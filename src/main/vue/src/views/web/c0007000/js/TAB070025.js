...
const grid = {
  ...
  fields: [
    ...
    { fieldName: '창고구분', dataType: ValueType.TEXT },
  ...
  columns: [
    ...
    { name: '창고', fieldName: '창고', width: 140, header: { text: '창고' }, styleName: 'tl' },
    { name: '창고구분', fieldName: '창고구분', width: 100, header: { text: '창고구분' }, styleName: 'tc' },
  ...
  layout: [
    '재고자산종류', '창고', '창고구분', '품목자산분류', '품목대분류', '품목중분류', '품목소분류',
