...
const grid = {
  ...
  columns: [
    ...
    { name: '선택', fieldName: '선택', width: '80', header: { text: '선택' }, autoFilter: true, styleName: 'tl' },
    { name: '출고처리', fieldName: '출고처리', width: '120', header: { text: '출고처리' }, autoFilter: true, styleName: 'tl' },
    ...
    { name: 'local구분', fieldName: 'local구분', width: '110', header: { text: 'Local구분' }, autoFilter: true, styleName: 'tl' },
    ...
    { name: '청구처', fieldName: '청구처', width: '90', header: { text: '청구처' }, autoFilter: true, styleName: 'tl' },
    { name: '거래처', fieldName: '거래처', width: '90', header: { text: '거래처' }, autoFilter: true, styleName: 'tl' },
    { name: '유통구조', fieldName: '유통구조', width: '120', header: { text: '유통구조' }, autoFilter: true, styleName: 'tl' },
    { name: '거래처번호', fieldName: '거래처번호', width: '150', header: { text: '거래처번호' }, autoFilter: true, styleName: 'tl' },
    { name: '중개인', fieldName: '중개인', width: '90', header: { text: '중개인' }, autoFilter: true, styleName: 'tl' },
    { name: '납품장소', fieldName: '납품장소', width: '120', header: { text: '납품장소' }, autoFilter: true, styleName: 'tl' },
    { name: '인도조건', fieldName: '인도조건', width: '120', header: { text: '인도조건' }, autoFilter: true, styleName: 'tl' },
    { name: '판매후보관', fieldName: '판매후보관', width: '150', header: { text: '판매후보관' }, autoFilter: true, styleName: 'tl' },
    { name: '위탁', fieldName: '위탁', width: '80', header: { text: '위탁' }, autoFilter: true, styleName: 'tl' },
    { name: '납품거래처', fieldName: '납품거래처', width: '150', header: { text: '납품거래처' }, autoFilter: true, styleName: 'tl' },
    ...
    { name: '판매단위', fieldName: '판매단위', width: '120', header: { text: '판매단위' }, autoFilter: true, styleName: 'tl' },
    ...
    { name: '부가세포함', fieldName: '부가세포함', width: '150', header: { text: '부가세포함' }, autoFilter: true, styleName: 'tl' },
    ...
    { name: '판매금액', fieldName: '판매금액', width: '120', header: { text: '판매금액' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.##' },
    { name: '부가세액', fieldName: '부가세액', width: '120', header: { text: '부가세액' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.##' },
    { name: '판매금액계', fieldName: '판매금액계', width: '150', header: { text: '판매금액계' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.##' },
    { name: '원화판매금액', fieldName: '원화판매금액', width: '180', header: { text: '원화판매금액' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.##' },
    { name: '원화부가세액', fieldName: '원화부가세액', width: '180', header: { text: '원화부가세액' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.##' },
    { name: '원화판매금액계', fieldName: '원화판매금액계', width: '210', header: { text: '원화판매금액계' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.##' },
    { name: '창고', fieldName: '창고', width: '80', header: { text: '창고' }, autoFilter: true, styleName: 'tl' },
    { name: '보관위치', fieldName: '보관위치', width: '120', header: { text: '보관위치' }, autoFilter: true, styleName: 'tl' },
    { name: 'lotNo', fieldName: 'lotNo', width: '80', header: { text: 'Lot_No' }, autoFilter: true, styleName: 'tl' },
    { name: '세금계산서진행상태', fieldName: '세금계산서진행상태', width: '280', header: { text: '세금계산서_진행상태' }, autoFilter: true, styleName: 'tl' },
    { name: '배송상태', fieldName: '배송상태', width: '120', header: { text: '배송상태' }, autoFilter: true, styleName: 'tl' },
    { name: '품목특이사항', fieldName: '품목특이사항', width: '180', header: { text: '품목특이사항' }, autoFilter: true, styleName: 'tl' },
    { name: '매출시점', fieldName: '매출시점', width: '120', header: { text: '매출시점' }, autoFilter: true, styleName: 'tl' },
    { name: '진행조회', fieldName: '진행조회', width: '120', header: { text: '진행조회' }, autoFilter: true, styleName: 'tl' },
    { name: '원천조회', fieldName: '원천조회', width: '120', header: { text: '원천조회' }, autoFilter: true, styleName: 'tl' },
    { name: '원천관리번호', fieldName: '원천관리번호', width: '180', header: { text: '원천관리번호' }, autoFilter: true, styleName: 'tl' },
    { name: '원천번호', fieldName: '원천번호', width: '120', header: { text: '원천번호' }, autoFilter: true, styleName: 'tl' },
    { name: 'poNo', fieldName: 'poNo', width: '80', header: { text: 'PO_No' }, autoFilter: true, styleName: 'tl' },
    { name: '반품', fieldName: '반품', width: '80', header: { text: '반품' }, autoFilter: true, styleName: 'tl' },
    { name: '매출수량', fieldName: '매출수량', width: '120', header: { text: '매출수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '매출금액계', fieldName: '매출금액계', width: '150', header: { text: '매출금액계' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '미매출금액', fieldName: '미매출금액', width: '150', header: { text: '미매출금액' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '세금계산서금액계', fieldName: '세금계산서금액계', width: '240', header: { text: '세금계산서금액계' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '계산서미발행액', fieldName: '계산서미발행액', width: '210', header: { text: '계산서미발행액' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '계산서미발행수량', fieldName: '계산서미발행수량', width: '240', header: { text: '계산서미발행수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '기타출고구분', fieldName: '기타출고구분', width: '180', header: { text: '기타출고구분' }, autoFilter: true, styleName: 'tl' },
    { name: '품목자산분류', fieldName: '품목자산분류', width: '180', header: { text: '품목자산분류' }, autoFilter: true, styleName: 'tl' },
    { name: '단가소급여부', fieldName: '단가소급여부', width: '180', header: { text: '단가소급여부' }, autoFilter: true, styleName: 'tl' },
    { name: '수량(단가소급)', fieldName: '수량(단가소급)', width: '220', header: { text: '수량(단가소급)' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '유상사급여부', fieldName: '유상사급여부', width: '180', header: { text: '유상사급여부' }, autoFilter: true, styleName: 'tl' },
  ],
};
