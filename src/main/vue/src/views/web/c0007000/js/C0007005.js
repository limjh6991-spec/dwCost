...
const grid = {
  ...
  columns: [
    ...
    { name: '판매기준가', fieldName: '판매기준가', width: '150', header: { text: '판매기준가' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0.##', footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' } },
    { name: '수량', fieldName: '수량', width: '80', header: { text: '수량' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0.##', footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' } },
    ...
    { name: '환율', fieldName: '환율', width: '80', header: { text: '환율' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0.##' , footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' }},
    { name: '판매단가', fieldName: '판매단가', width: '120', header: { text: '판매단가' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0.##' , footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' }},
    { name: '판매금액', fieldName: '판매금액', width: '120', header: { text: '판매금액' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0.##' , footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' }},
    { name: '부가세액', fieldName: '부가세액', width: '120', header: { text: '부가세액' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0.##' , footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' }},
    { name: '판매금액계', fieldName: '판매금액계', width: '150', header: { text: '판매금액계' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0.##', footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' } },
    { name: '원화판매금액', fieldName: '원화판매금액', width: '180', header: { text: '원화판매금액' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0.##', footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' } },
    { name: '원화부가세액', fieldName: '원화부가세액', width: '180', header: { text: '원화부가세액' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0.##' , footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' }},
    { name: '원화판매금액계', fieldName: '원화판매금액계', width: '210', header: { text: '원화판매금액계' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0.##', footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' } },
    ...
    { name: '매출수량', fieldName: '매출수량', width: '120', header: { text: '매출수량' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0', footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' } },
    { name: '매출금액계', fieldName: '매출금액계', width: '150', header: { text: '매출금액계' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0', footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' } },
    { name: '미매출금액', fieldName: '미매출금액', width: '150', header: { text: '미매출금액' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0', footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' } },
    { name: '세금계산서금액계', fieldName: '세금계산서금액계', width: '240', header: { text: '세금계산서금액계' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0', footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' } },
    { name: '계산서미발행액', fieldName: '계산서미발행액', width: '210', header: { text: '계산서미발행액' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0', footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' } },
    { name: '계산서미발행수량', fieldName: '계산서미발행수량', width: '240', header: { text: '계산서미발행수량' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0' , footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' }},
    ...
    { name: '수량(단가소급)', fieldName: '수량(단가소급)', width: '220', header: { text: '수량(단가소급)' }, autoFilter: true, styleName: 'edit tr', numberFormat: '#,##0' , footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' }},
