...
const grid = {
  ...
  columns: [
    ...
    { name: 'dwSiteOrg', fieldName: 'dwSiteOrg', width: '0', header: { text: 'DW_SITE_ORG' }, autoFilter: true, visible: false, editable: false, styleName: 'tl' },
    {
      name: 'dwSite',
      fieldName: 'dwSite',
      width: '80',
    ...
    { name: 'site', fieldName: 'site', width: '80', header: { text: 'Site' }, autoFilter: true, editable: true, styleName: 'edit tl' },
