...
const grid = {
  ...
  columns: [
    ...
    { name: '수량', fieldName: '수량', width: '100', header: { text: '수량' }, autoFilter: true, editable: true, styleName: 'tr', numberFormat: '#,##0', footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' }, styleCallback: addNewRow('tl') },
    ...
    { name: '기준단위수량', fieldName: '기준단위수량', width: '100', header: { text: '기준단위수량' }, autoFilter: true, editable: true, styleName: 'tr', numberFormat: '#,##0', footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' }, styleCallback: addNewRow('tl') },
    ...
    { name: '현재고', fieldName: '현재고', width: '100', header: { text: '현재고' }, autoFilter: true, editable: true, styleName: 'tr', numberFormat: '#,##0', footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' }, styleCallback: addNewRow('tl') },
