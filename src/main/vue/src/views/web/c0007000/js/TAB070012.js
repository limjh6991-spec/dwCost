...
const grid = {
  ...
  fields: [
    ...
    { fieldName: '차이수량aB', dataType: ValueType.NUMBER },
    { fieldName: '재고금액c', dataType: ValueType.NUMBER },
    { fieldName: '결산재고금액d', dataType: ValueType.NUMBER },
    { fieldName: '차이금액cD', dataType: ValueType.NUMBER },
  ...
  columns: [
    ...
    { name: '차이수량aB', fieldName: '차이수량aB', width: '100', header: { text: '차이수량A_B' }, autoFilter: true, editable: true, styleName: 'tr', numberFormat: '#,##0', footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' }, styleCallback: addNewRow('tr') },
    ...
    { name: '차이금액cD', fieldName: '차이금액cD', width: '120', header: { text: '차이금액C_D' }, autoFilter: true, editable: true, styleName: 'tr', numberFormat: '#,##0', footer: { expression: 'sum', numberFormat: '#,##0', styleName: 'sum-footer1' }, styleCallback: addNewRow('tr') },
