...
const grid = {
  ...
  columns: [
    ...
    { name: 'IN_QTY', fieldName: 'inQty', width: '135', header: { text: 'IN_QTY' }, autoFilter: true, editable: true, styleName: 'edit tr', numberFormat: '#,##0' },
    ...
    { name: 'IN_AMT', fieldName: 'inAmt', width: '70', header: { text: 'IN_AMT' }, autoFilter: true, editable: true, styleName: 'edit tr', numberFormat: '#,##0.##' },
