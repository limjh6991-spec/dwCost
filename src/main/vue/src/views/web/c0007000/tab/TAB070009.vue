...
import gridField from '@web/c0007000/js/TAB070009.js';
...
export default {
  ...
  methods: {
    ...
    addBtnClick() {
      ...
      this.gridView.commit();
      this.gridDataProvider.addRow({ yyyymm: this.params.yyyymm != null ? this.params.yyyymm.replaceAll('-', '') : null, site: this.siteMap[this.params.site] });
      ...
      if (rslt === null) {
        this.$confirm('확인', '수정하신 내용을 저장 하시겠습니까?', async (confirm) => {
          if (confirm) {
            let param = {
              menuId: 'c0007010',
              delete: [{ queryId: 'C0007010_Delete1', data: saveData.delete }],
              insert: [{ queryId: 'C0007010_Insert1', data: saveData.insert }],
              update: [{ queryId: 'C0007010_Update1', data: saveData.update }],
            };
