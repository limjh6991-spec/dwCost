      ...
      this.$confirm('확인', `${deletedCount}건을 삭제하시겠습니까?`, async (confirmed) => {
        ...
        if (existingRows.length > 0) {
          try {
            let param = {
              menuId: 'c0007004',
              delete: [{ queryId: 'C0007004_Delete1', data: existingRows }],
            };
      ...
      if (rslt === null) {
        this.$confirm('확인', '수정하신 내용을 저장 하시겠습니까?', async (confirm) => {
          if (confirm) {
            let param = {
              menuId: 'c0007004',
              delete: [{ queryId: 'C0007004_Delete1', data: saveData.delete }],
              insert: [{ queryId: 'C0007004_Insert1', data: saveData.insert }],
              update: [{ queryId: 'C0007004_Update1', data: saveData.update }],
            };
