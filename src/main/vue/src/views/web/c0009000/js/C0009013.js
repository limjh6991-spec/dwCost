...
const grid = {
  ...
  columns: [
    ...
    { name: 'inMonth', fieldName: 'inMonth', width: '120', header: { text: '투입수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: 'distRate', fieldName: 'distRate', width: '120', header: { text: '배부비율' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.0000' },
    { name: 'finalAmt', fieldName: 'finalAmt', width: '120', header: { text: '배부금액' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
  ],
};
