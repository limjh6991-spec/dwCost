...
const grid = {
  ...
  columns: [
    ...
    { name: '취득원가', fieldName: '취득원가', width: '100', header: { text: '취득원가' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0'},
    { name: '판매단가Krw', fieldName: '판매단가Krw', width: '100', header: { text: '판매단가(KRW)' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.00' },
    { name: '판매단가Usd', fieldName: '판매단가Usd', width: '100', header: { text: '판매단가(USD)' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.00' },
    { name: '환율', fieldName: '환율', width: '100', header: { text: '환율' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.00' },
    { name: 'nrv', fieldName: 'nrv', width: '100', header: { text: 'NRV' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0'},
