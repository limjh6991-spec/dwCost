...
const grid = {
  ...
  columnLayout: [
    ...
    { column: '계획대비실적' },
    {
      ...
      items: [{ column: 'qty1' }, { column: 'amt1' }, { column: 'price1' }],
    },
    {
      name: 'grp2월',
      header: { text: '2월' },
      direction: 'horizontal',
      items: [{ column: 'qty2' }, { column: 'amt2' }, { column: 'price2' }],
    },
    {
      name: 'grp3월',
      header: { text: '3월' },
      direction: 'horizontal',
      items: [{ column: 'qty3' }, { column: 'amt3' }, { column: 'price3' }],
    },
    {
      name: 'grp4월',
      header: { text: '4월' },
      direction: 'horizontal',
      items: [{ column: 'qty4' }, { column: 'amt4' }, { column: 'price4' }],
    },
        {
      name: 'grp5월',
      header: { text: '5월' },
      direction: 'horizontal',
      items: [{ column: 'qty5' }, { column: 'amt5' }, { column: 'price5' }],
    },
        {
      name: 'grp6월',
      header: { text: '6월' },
      direction: 'horizontal',
      items: [{ column: 'qty6' }, { column: 'amt6' }, { column: 'price6' }],
    },
        {
      name: 'grp7월',
      header: { text: '7월' },
      direction: 'horizontal',
      items: [{ column: 'qty7' }, { column: 'amt7' }, { column: 'price7' }],
    },
        {
      name: 'grp8월',
      header: { text: '8월' },
      direction: 'horizontal',
      items: [{ column: 'qty8' }, { column: 'amt8' }, { column: 'price8' }],
    },
        {
      name: 'grp9월',
      header: { text: '9월' },
      direction: 'horizontal',
      items: [{ column: 'qty9' }, { column: 'amt9' }, { column: 'price9' }],
    },
        {
      name: 'grp10월',
      header: { text: '10월' },
      direction: 'horizontal',
      items: [{ column: 'qty10' }, { column: 'amt10' }, { column: 'price10' }],
    },
        {
      name: 'grp11월',
      header: { text: '11월' },
      direction: 'horizontal',
      items: [{ column: 'qty11' }, { column: 'amt11' }, { column: 'price11' }],
    },
    {
      name: 'grp12월',
      header: { text: '12월' },
      direction: 'horizontal',
      items: [{ column: 'qty12' }, { column: 'amt12' }, { column: 'price12' }],
    },
  ],
    columns: [
