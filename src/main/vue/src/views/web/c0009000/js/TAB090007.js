...
const grid = {
  ...
  { fieldName: 'outGoodRtnQty', dataType: ValueType.NUMBER },
  { fieldName: 'outGoodRtnAmt', dataType: ValueType.NUMBER },
  ...
  columnLayout: [
    ...
    // 입고상세 — expandable (+/- 버튼)
    {
      ...
      items: [
        ...
        { name: 'grpRmaIn', header: { text: 'RMA(품번변경)' }, groupShowMode: 'expand',
    ...
    // 출고상세 — expandable (+/- 버튼)
    {
      ...
      direction: 'horizontal',
      items: [
        { name: 'grpOutGood', header: { text: '양품(출고)' }, groupShowMode: 'always',
          direction: 'horizontal', items: [{ column: 'outGoodQty' }, { column: 'outGoodAmt' }] },
        { name: 'grpOutGoodRtn', header: { text: '양품(반품입고)' }, groupShowMode: 'always',
          direction: 'horizontal', items: [{ column: 'outGoodRtnQty' }, { column: 'outGoodRtnAmt' }] },
        { name: 'grpOutEtc', header: { text: '타계정' }, groupShowMode: 'always',
          direction: 'horizontal', items: [{ column: 'outEtcQty' }, { column: 'outEtcAmt' }] },
        { name: 'grpOutRma', header: { text: 'RMA(품번변경)' }, groupShowMode: 'expand',
  ...
  { name: 'outGoodRtnQty', fieldName: 'outGoodRtnQty', width: 80, header: { text: '수량' }, styleName: 'tr', numberFormat: '#,##0' },
  { name: 'outGoodRtnAmt', fieldName: 'outGoodRtnAmt', width: 100, header: { text: '금액' }, styleName: 'tr', numberFormat: '#,##0' },
