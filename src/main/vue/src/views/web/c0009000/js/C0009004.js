...
const grid = {
  ...
  columns: [
    ...
    { name: '기초수량', fieldName: '기초수량', width: '100', header: { text: '기초수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.0000', footer: { expression: "sum", numberFormat: "#,##0.0000", styleName: "sum-footer1",} },
    ...
    { name: '입고수량', fieldName: '입고수량', width: '100', header: { text: '입고수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.0000', footer: { expression: "sum", numberFormat: "#,##0.0000", styleName: "sum-footer1",} },
    ...
    { name: '출고수량', fieldName: '출고수량', width: '100', header: { text: '출고수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.0000', footer: { expression: "sum", numberFormat: "#,##0.0000", styleName: "sum-footer1",} },
    ...
    { name: '재고수량', fieldName: '재고수량', width: '100', header: { text: '재고수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.0000', footer: { expression: "sum", numberFormat: "#,##0.0000", styleName: "sum-footer1",} },
    ...
    { name: '구매수량', fieldName: '구매수량', width: '100', header: { text: '구매수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.0000', footer: { expression: "sum", numberFormat: "#,##0.0000", styleName: "sum-footer1",} },
    ...
    { name: '기타입고수량', fieldName: '기타입고수량', width: '120', header: { text: '기타입고수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.0000', footer: { expression: "sum", numberFormat: "#,##0.0000", styleName: "sum-footer1",} },
    ...
    { name: '판매수량', fieldName: '판매수량', width: '100', header: { text: '판매수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.0000', footer: { expression: "sum", numberFormat: "#,##0.0000", styleName: "sum-footer1",} },
    { name: '판매원가', fieldName: '판매원가', width: '100', header: { text: '판매원가' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.00' },
    { name: '투입수량', fieldName: '투입수량', width: '100', header: { text: '투입수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.0000', footer: { expression: "sum", numberFormat: "#,##0", styleName: "sum-footer1",} },
    ...
    { name: '기타출고수량', fieldName: '기타출고수량', width: '120', header: { text: '기타출고수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.0000', footer: { expression: "sum", numberFormat: "#,##0", styleName: "sum-footer1",} },
