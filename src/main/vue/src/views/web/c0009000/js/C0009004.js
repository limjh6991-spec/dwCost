...
const grid = {
  ...
  columns: [
    ...
    { name: '기초수량', fieldName: '기초수량', width: '100', header: { text: '기초수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '기초금액', fieldName: '기초금액', width: '120', header: { text: '기초금액' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '입고수량', fieldName: '입고수량', width: '100', header: { text: '입고수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '입고금액', fieldName: '입고금액', width: '120', header: { text: '입고금액' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '출고수량', fieldName: '출고수량', width: '100', header: { text: '출고수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '출고금액', fieldName: '출고금액', width: '120', header: { text: '출고금액' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '재고수량', fieldName: '재고수량', width: '100', header: { text: '재고수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '재고금액', fieldName: '재고금액', width: '120', header: { text: '재고금액' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    ...
    { name: '구매수량', fieldName: '구매수량', width: '100', header: { text: '구매수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '구매금액', fieldName: '구매금액', width: '120', header: { text: '구매금액' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '기타입고수량', fieldName: '기타입고수량', width: '120', header: { text: '기타입고수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '기타입고금액', fieldName: '기타입고금액', width: '120', header: { text: '기타입고금액' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '판매수량', fieldName: '판매수량', width: '100', header: { text: '판매수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '판매원가', fieldName: '판매원가', width: '100', header: { text: '판매원가' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.00' },
    { name: '투입수량', fieldName: '투입수량', width: '100', header: { text: '투입수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '투입금액', fieldName: '투입금액', width: '120', header: { text: '투입금액' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '기타출고수량', fieldName: '기타출고수량', width: '120', header: { text: '기타출고수량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '기타출고금액', fieldName: '기타출고금액', width: '120', header: { text: '기타출고금액' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
  ],
};
