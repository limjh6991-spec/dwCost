...
const grid = {
  ...
  columns: [
    ...
    numCol('backShipSorting', 'backShipSorting', '3. BACK-SHIP\n(SORTING)', 110),
    numCol('backShipPfRw', 'backShipPfRw', '4. BACK-SHIP\n(PF-RW)', 110),
    numCol('backShipPlRw', 'backShipPlRw', '5. BACK-SHIP\n(PL-RW)', 110),
    numCol('whReturnSorting', 'whReturnSorting', '6. WH RETURN\n(SORTING)', 110),
    numCol('whReturnPfRw', 'whReturnPfRw', '7. WH RETURN\n(PF-RW)', 110),
    numCol('whReturnPlRw', 'whReturnPlRw', '8. WH RETURN\n(PL-RW)', 110),
