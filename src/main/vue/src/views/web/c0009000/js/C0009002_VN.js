...
const grid = {
  ...
  columns: [
    ...
    numCol('tInput', 'tInput', 'T_INPUT (9=1-8)', 110),
    ...
    numCol('ieTotal', 'ieTotal', '기타입고 (5=1+2+3+4)', 120),
    numCol('shipAPaid', 'shipAPaid', 'PAID'),
    numCol('shipBPaid', 'shipBPaid', 'PAID'),
    numCol('tOutput', 'tOutput', 'T_OUTPUT (3=1+2)', 110),
    ...
    numCol('oeTotal', 'oeTotal', '기타출고 (6=1+2+3+4+5)', 130),
