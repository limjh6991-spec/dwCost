...
const grid = {
  ...
  fields: [
    ...
    { fieldName: '배부율', dataType: ValueType.NUMBER },
  ...
  columns: [
    ...
    { name: '도우모델', fieldName: '도우모델', width: '120', header: { text: '모델명' }, autoFilter: true, styleName: 'tl' },
    ...
    { name: 'inAmt', fieldName: 'inAmt', width: '80', header: { text: '투입금액' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '환산량', fieldName: '환산량', width: '90', header: { text: '환산량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '배부방식', fieldName: '배부방식', width: '150', header: { text: '배부방식' }, autoFilter: true, styleName: 'tl' },
    { name: '소요량', fieldName: '소요량', width: '90', header: { text: '소요량' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0' },
    { name: '배부율', fieldName: '배부율', width: '120', header: { text: '배부율' }, autoFilter: true, styleName: 'tr', numberFormat: '#,##0.#####', footer: { text: '합계' } },
