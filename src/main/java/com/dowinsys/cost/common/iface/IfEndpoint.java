...
public enum IfEndpoint {
    ...
    ITEM         (IfSource.ERP, "/Angkor.Ylw.Common.HttpExecute/RestOutsideService.svc/OpenApi/WBS.Ylw.Sales.BSSDAItemInfo/Query",                                          "UP_VN_IF_LOAD_ITEM",          false, "UP_VN_IF_XFORM_ITEM"),  // 품목→면적기준정보 DOI_MODEL_MAST[VN] (장변×단변, DataBlock4 CMF)
    ...
    ITEM_PROC_MAT(IfSource.ERP, "/Angkor.Ylw.Common.HttpExecute/RestOutsideService.svc/OpenApi/WBS.Ylw.Production.BSSPDROUItemProcMatList/Query",                          "UP_VN_IF_LOAD_ITEM_PROC_MAT", true, "UP_VN_IF_XFORM_ITEM_PROC_MAT"),  // 소요자재→DOI_BOM_MAST[VN] (HQ MATERIAL_HQ 미러)
    ...
    WH_STOCK_SUM_HQ (IfSource.ERP, "/Angkor.Ylw.Common.HttpExecute/RestOutsideService.svc/OpenApi/WBS.Ylw.Logistics.BSSLGWHStock/WHStockSumQuery",                             "UP_HQ_IF_LOAD_WH_STOCK_SUM",  true,  "UP_HQ_IF_XFORM_WH_STOCK_SUM"),         // 제품정보(창고별수불집계)→DOI_STOCK[HQ]
