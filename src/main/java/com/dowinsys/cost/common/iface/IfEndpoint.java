...
public enum IfEndpoint {
    ...
    DEPT_COST    (IfSource.ERP, "/Angkor.Ylw.Common.HttpExecute/RestOutsideService.svc/OpenApi/Wbs.Ylw.Account.BSSACCCtrCostAmtExeList/Query_ACCCtrCostAmtExeL",            "UP_VN_IF_LOAD_DEPT_COST",     true),
    ...
    ETC_INOUT    (IfSource.ERP, "/Angkor.Ylw.Common.HttpExecute/RestOutsideService.svc/OpenApi/WBS.Ylw.ESM.BSSESMCEtcOutAmt/Query",                                        "UP_VN_IF_LOAD_ETC_INOUT",     true),
    STOCK_DETAIL (IfSource.ERP, "/Angkor.Ylw.Common.HttpExecute/RestOutsideService.svc/OpenApi/WBS.Ylw.ESM.BSSESMZStockMonthlyAmt/Query",                                  "UP_VN_IF_LOAD_STOCK_DETAIL",  true),
    ...
    EXP_SALES    (IfSource.ERP, "/Angkor.Ylw.Common.HttpExecute/RestOutsideService.svc/OpenApi/WBS.Ylw.Sales.BSSSLSalesInfo/ExpSalesItemQuery",                            "UP_VN_IF_LOAD_EXP_SALES",     true),
    ...
    FG_SUBUL     (IfSource.MES, "/api/v1/fg_inv",  "UP_VN_IF_LOAD_FG_SUBUL",  true);
