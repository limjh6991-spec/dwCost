...
@RestController("com.dowinsys.cost.web.c0007000.controller.C0007017Controller")
@RequestMapping("/api/c0007000/c0007017")
public class C0007017Controller {

    @Autowired
    C0007017Service service;
