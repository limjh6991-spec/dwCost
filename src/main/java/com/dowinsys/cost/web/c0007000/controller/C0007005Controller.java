...
@RestController("com.dowinsys.cost.web.c0007000.controller.C0007005Controller")
@RequestMapping("/api/c0007000/c0007005")
public class C0007005Controller {

    @Autowired
    C0007005Service service;
