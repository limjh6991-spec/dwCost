...
@RestController("com.dowinsys.cost.web.c0001000.controller.TAB010001Controller")
@RequestMapping("/api/c0001000/TAB010001")
public class TAB010001Controller {

    @Autowired
    TAB010001Service service;
