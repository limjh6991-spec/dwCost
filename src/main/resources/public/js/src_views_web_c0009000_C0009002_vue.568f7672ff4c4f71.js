...
const grid = {
  ...
  columns: [{
    ...
    styleName: 'tc',
    autoFilter: true
  }, numCol('boh', 'boh', 'BOH'), numCol('fgLastMonth', 'fgLastMonth', 'LAST-MONTH', 100), numCol('fgThisMonth', 'fgThisMonth', 'THIS-MONTH', 100), numCol('backShipSorting', 'backShipSorting', 'BACK-SHIP(SORTING)', 110), numCol('backShipPfRw', 'backShipPfRw', 'BACK-SHIP(PF-RW)', 110), numCol('backShipPlRw', 'backShipPlRw', 'BACK-SHIP(PL-RW)', 110), numCol('whReturnSorting', 'whReturnSorting', 'WH RETURN(SORTING)', 110), numCol('whReturnPfRw', 'whReturnPfRw', 'WH RETURN(PF-RW)', 110), numCol('whReturnPlRw', 'whReturnPlRw', 'WH RETURN(PL-RW)', 110), numCol('tInput', 'tInput', 'T_INPUT', 100), numCol('ieRma', 'ieRma', 'RMA'), numCol('ieReturnPaid', 'ieReturnPaid', '반품품(유상)', 100), numCol('ieReturnFree', 'ieReturnFree', '반품품(무상)', 100), numCol('ieOther', 'ieOther', '기타'), numCol('ieTotal', 'ieTotal', '기타입고', 100), numCol('shipAPaid', 'shipAPaid', 'PAID'), numCol('shipBPaid', 'shipBPaid', 'PAID'), numCol('tOutput', 'tOutput', 'T_OUTPUT', 100), numCol('oeResorting', 'oeResorting', 'Re-Sorting(재검사)', 120), numCol('oeRework', 'oeRework', 'Re-work(SI검사)', 120), numCol('oeRma', 'oeRma', 'RMA'), numCol('oeFreeSale', 'oeFreeSale', '무상매출', 100), numCol('oeOther', 'oeOther', '기타'), numCol('oeTotal', 'oeTotal', '기타출고', 100), numCol('loss', 'loss', 'LOSS'), numCol('eoh', 'eoh', 'EOH WH0006', 110)],
  columnLayout: [{
    column: 'model'
  }, {
    column: 'boh'
...
//# sourceMappingURL=src_views_web_c0009000_C0009002_vue.568f7672ff4c4f71.js.map