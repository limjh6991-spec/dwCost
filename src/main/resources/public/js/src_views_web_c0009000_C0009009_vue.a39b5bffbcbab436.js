(self["webpackChunkvue"] = self["webpackChunkvue"] || []).push([["src_views_web_c0009000_C0009009_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/web/c0009000/C0009009.vue?vue&type=script&lang=js":
/*!**************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/web/c0009000/C0009009.vue?vue&type=script&lang=js ***!
  \**************************************************************************************************************************************************************************************************/
...
/* harmony import */ var realgrid__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! realgrid */ "./node_modules/realgrid/dist/main.esm.js");
/* harmony import */ var _store_auth_userAuthInfo__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @store/auth/userAuthInfo */ "./src/store/auth/userAuthInfo.js");
/* harmony import */ var _web_store_C0001001_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @web/store/C0001001.js */ "./src/views/web/store/C0001001.js");
/* harmony import */ var _utils_gridUtils__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @/utils/gridUtils */ "./src/utils/gridUtils.js");
/* harmony import */ var _web_c0007000_js_currencyConvert_js__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @web/c0007000/js/currencyConvert.js */ "./src/views/web/c0007000/js/currencyConvert.js");
/* harmony import */ var _components_ExchangeRatePopup_vue__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @/components/ExchangeRatePopup.vue */ "./src/components/ExchangeRatePopup.vue");
/* harmony import */ var _web_c0009000_js_C0009009_js__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @web/c0009000/js/C0009009.js */ "./src/views/web/c0009000/js/C0009009.js");
/* harmony import */ var _web_c0009000_js_C0009009_js__WEBPACK_IMPORTED_MODULE_21___default = /*#__PURE__*/__webpack_require__.n(_web_c0009000_js_C0009009_js__WEBPACK_IMPORTED_MODULE_21__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [_web_c0007000_js_currencyConvert_js__WEBPACK_IMPORTED_MODULE_19__["default"]],
  components: {
    ExchangeRatePopup: _components_ExchangeRatePopup_vue__WEBPACK_IMPORTED_MODULE_20__["default"]
  },
  setup() {
    const srchInfo = (0,_web_store_C0001001_js__WEBPACK_IMPORTED_MODULE_17__.useC0001001)();
    const userAuthInfo = (0,_store_auth_userAuthInfo__WEBPACK_IMPORTED_MODULE_16__.useUserAuthInfo)();
    return {
      srchInfo,
      userAuthInfo
    };
  ...
  methods: {
    ...
    initializeGrid() {
      this.modelPlGrid = _.cloneDeep((_web_c0009000_js_C0009009_js__WEBPACK_IMPORTED_MODULE_21___default()));
      modelPlTreeProvider = new realgrid__WEBPACK_IMPORTED_MODULE_15__.LocalTreeDataProvider(false);
      modelPlTreeView = new realgrid__WEBPACK_IMPORTED_MODULE_15__.TreeView(this.$refs.modelPlTree);
    ...
    makeFieldId(pivotKey) {
      ...
      if (!s) return '';
      return 'COL_' + s.replace(/\s+/g, '_').replace(/[^\wㄱ-힣]/g, '_');
    },
    ...
    buildHeaderMetaFromSch1(amountRows, displayMap) {
      ...
      if (!first) return [];
      const ignore = new Set(['rn', 'gubun', 'z합계', 'zTotal', 'Z합계', '개발z합계개발', '개발Z합계개발', 'z합계개발', 'Z합계개발', 'zDevTotal', '양산z합계양산', '양산Z합계양산', 'z합계양산', 'Z합계양산', 'zMassTotal', '카세트z합계카세트', '카세트Z합계카세트', 'z합계카세트', 'Z합계카세트', 'zCassetteTotal', '구매z합계구매', '구매Z합계구매', 'z합계구매', 'Z합계구매', 'zPurchaseTotal']);
      return Object.keys(first).filter(k => !ignore.has(k)).map(pivotKey => {
        let gubun = '양산';
        if (pivotKey.startsWith('개발')) gubun = '개발';else if (pivotKey.startsWith('카세트')) gubun = '카세트';else if (pivotKey.startsWith('구매')) gubun = '구매';
    ...
    buildQtyRow(headerMeta, qtyRespRows) {
      ...
      const sum = g => headerMeta.filter(x => x.gubun === g).reduce((acc, m) => acc + Number(row[m.fieldId] || 0), 0);
    ...
    async getDataList() {
      ...
      const baseGrid = _.cloneDeep((_web_c0009000_js_C0009009_js__WEBPACK_IMPORTED_MODULE_21___default()));
      ...
      const sortByModel = (a, b) => a.model.localeCompare(b.model, undefined, {
        sensitivity: 'base'
      });
      ...
      const layout = [{
        ...
        items: [{
          ...
          column: 'zCassetteTotal',
          header: {
            text: '카세트'
          }
        }, {
          column: 'zPurchaseTotal',
          header: {
            text: '구매'
          }
        }]
      ...
      (0,_utils_gridUtils__WEBPACK_IMPORTED_MODULE_18__.applyAmtFormatLive)(modelPlTreeView, this.userAuthInfo.curProdCtg, this.currency);
      ...
      const finalRows = isDetail ? this.buildTreeRowsMultiLevel(amountRows) : this.buildTreeRows([qtyRow, ...amountRows]);
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/web/c0009000/C0009009.vue?vue&type=template&id=29a717b3&scoped=true":
/*!******************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/web/c0009000/C0009009.vue?vue&type=template&id=29a717b3&scoped=true ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const _hoisted_14 = {
  key: 0,
  class: "nav nav-tabs model_pl_tab"
};
const _hoisted_15 = {
  class: "nav-item"
};
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_b_row, {
    ...
    default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_b_col, {
      ...
      default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
        ...
        value: "VND"
      }, "VND", -1 /* CACHED */)]))], 40 /* PROPS, NEED_HYDRATION */, _hoisted_7), _cache[10] || (_cache[10] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
        for: "currencySelect"
      }, "통화", -1 /* CACHED */))])]),
      _: 1 /* STABLE */
    })) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), _ctx.showCurrencySelect ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_b_col, {
      ...
      default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_8, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
        ...
        placeholder: "기준환율",
        disabled: true
      }, null, 8 /* PROPS */, _hoisted_9), _cache[11] || (_cache[11] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
        for: "baseRate"
      }, "기준환율", -1 /* CACHED */))])]),
      _: 1 /* STABLE */
    })) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), _ctx.showCurrencySelect ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_b_col, {
    ...
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["onClick"])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_12, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_13, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" VN 화면 전용 탭 (HQ는 단일 트리 그리드 유지) "), $options.isVN ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_14, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", _hoisted_15, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
    class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["nav-link", {
      active: $data.activeTab === 'monthly'
    }]),
    onClick: _cache[4] || (_cache[4] = $event => $options.switchTab('monthly'))
  }, "월별", 2 /* CLASS */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", _hoisted_16, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
    class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["nav-link", {
      active: $data.activeTab === 'vn'
    }]),
    onClick: _cache[5] || (_cache[5] = $event => $options.switchTab('vn'))
  }, "VN", 2 /* CLASS */)])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_17, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_b_button, {
    class: "second",
    ...
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["onClick"])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_18, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_19, null, 512 /* NEED_PATCH */)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_ExchangeRatePopup, {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/web/c0009000/C0009009.vue?vue&type=style&index=0&id=29a717b3&scoped=true&lang=css":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/web/c0009000/C0009009.vue?vue&type=style&index=0&id=29a717b3&scoped=true&lang=css ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\r\n/* VN 전용 탭 바 — 40px left_box 안에 컴팩트하게 배치 */\n.model_pl_tab[data-v-29a717b3] {\r\n  border-bottom: 0;\r\n  margin-bottom: 0;\r\n  flex-wrap: nowrap;\r\n  align-items: center;\n}\n.model_pl_tab .nav-link[data-v-29a717b3] {\r\n  padding: 4px 16px;\r\n  font-size: 13px;\r\n  color: #555;\r\n  border: 1px solid transparent;\r\n  border-radius: 4px 4px 0 0;\r\n  cursor: pointer;\r\n  line-height: 1.4;\n}\n.model_pl_tab .nav-link.active[data-v-29a717b3] {\r\n  color: #232f4e;\r\n  font-weight: 600;\r\n  background: #fff;\r\n  border-color: #bebebe #bebebe #fff;\n}\r\n", ""]);
// Exports
...
// load the styles
var content = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!../../../../node_modules/vue-loader/dist/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./C0009009.vue?vue&type=style&index=0&id=29a717b3&scoped=true&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/web/c0009000/C0009009.vue?vue&type=style&index=0&id=29a717b3&scoped=true&lang=css");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.id, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = (__webpack_require__(/*! !../../../../node_modules/vue-style-loader/lib/addStylesClient.js */ "./node_modules/vue-style-loader/lib/addStylesClient.js")["default"])
var update = add("c7dbdae0", content, false, {"sourceMap":false,"shadowMode":false});
...
/***/ "./src/views/web/c0009000/C0009009.vue":
/*!*********************************************!*\
  !*** ./src/views/web/c0009000/C0009009.vue ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _C0009009_vue_vue_type_template_id_29a717b3_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./C0009009.vue?vue&type=template&id=29a717b3&scoped=true */ "./src/views/web/c0009000/C0009009.vue?vue&type=template&id=29a717b3&scoped=true");
/* harmony import */ var _C0009009_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./C0009009.vue?vue&type=script&lang=js */ "./src/views/web/c0009000/C0009009.vue?vue&type=script&lang=js");
/* harmony import */ var _C0009009_vue_vue_type_style_index_0_id_29a717b3_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./C0009009.vue?vue&type=style&index=0&id=29a717b3&scoped=true&lang=css */ "./src/views/web/c0009000/C0009009.vue?vue&type=style&index=0&id=29a717b3&scoped=true&lang=css");
...
const __exports__ = /*#__PURE__*/(0,_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__["default"])(_C0009009_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_C0009009_vue_vue_type_template_id_29a717b3_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render],['__scopeId',"data-v-29a717b3"],['__file',"src/views/web/c0009000/C0009009.vue"]])
/* hot reload */
if (false) // removed by dead control flow
{}
...
/***/ "./src/views/web/c0009000/C0009009.vue?vue&type=script&lang=js":
/*!*********************************************************************!*\
  !*** ./src/views/web/c0009000/C0009009.vue?vue&type=script&lang=js ***!
  \*********************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_40_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_C0009009_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]; }
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_40_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_C0009009_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[0]!../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./C0009009.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/web/c0009000/C0009009.vue?vue&type=script&lang=js");
 

/***/ }),

/***/ "./src/views/web/c0009000/C0009009.vue?vue&type=style&index=0&id=29a717b3&scoped=true&lang=css":
/*!*****************************************************************************************************!*\
  !*** ./src/views/web/c0009000/C0009009.vue?vue&type=style&index=0&id=29a717b3&scoped=true&lang=css ***!
  \*****************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_clonedRuleSet_12_use_0_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0