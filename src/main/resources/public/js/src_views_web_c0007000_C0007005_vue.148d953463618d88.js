  ...
  methods: {
    ...
    async callIface({
      ...
      const proceed = await new Promise(resolve => {
        try {
          this.$confirm('확인', `${successLabel || key} API를 호출하시겠습니까? (해당 월 데이터가 갱신됩니다)`, ok => resolve(ok === true));
        } catch (e) {
...
//# sourceMappingURL=src_views_web_c0007000_C0007005_vue.148d953463618d88.js.map