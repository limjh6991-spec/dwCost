...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    buildHeaderMetaFromSch1(amountRows, displayMap) {
      ...
      if (!first) return [];
      const ignore = new Set(['rn', 'gubun', 'z합계', 'zTotal', 'Z합계', '개발z합계개발', '개발Z합계개발', 'z합계개발', 'Z합계개발', 'zDevTotal', '양산z합계양산', '양산Z합계양산', 'z합계양산', 'Z합계양산', 'zMassTotal', '카세트z합계카세트', '카세트Z합계카세트', 'z합계카세트', 'Z합계카세트', 'zCassetteTotal', '구매z합계구매', '구매Z합계구매', 'z합계구매', 'Z합계구매', 'zPurchaseTotal', '회계z합계회계', '회계Z합계회계', 'z합계회계', 'Z합계회계', 'zAccTotal']);
      return Object.keys(first).filter(k => !ignore.has(k)).map(pivotKey => {
        let gubun = '양산';
        if (pivotKey.startsWith('개발')) gubun = '개발';else if (pivotKey.startsWith('카세트')) gubun = '카세트';else if (pivotKey.startsWith('구매')) gubun = '구매';else if (pivotKey.startsWith('회계')) gubun = '회계';
...
//# sourceMappingURL=src_views_web_c0009000_C0009009_vue.74b6a504b330776f.js.map