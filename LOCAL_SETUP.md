...
| 항목 | 값 |
|------|-----|
| **URL** | http://10.100.40.19:9090 |
| **호스트** | 10.100.40.19 |
| **포트** | 9090 |
| **DB** | 10.100.40.250:1433 / 도우제조MES시스템 |
| **용도** | 실제 결산 데이터 운영, 본사 사용자 접속 |

### 개발 서버 (Development)
| 항목 | 값 |
|------|-----|
| **URL** | http://10.100.40.19:9091 |
| **호스트** | 10.100.40.19 |
| **포트** | 9091 |
| **DB** | 10.100.40.250:1433 / 도우제조MES시스템TEST |
| **용도** | 기능 개발/테스트, 결산 로직 검증 |

### 로컬 서버 (Local Development)
| 항목 | 값 |
|------|-----|
| **URL** | http://localhost:9090 |
| **포트** | 9090 |
...
> ⚠️ **주의**: 운영/개발 서버 접속 시 VPN 연결 필수 (dowoo VPN)
