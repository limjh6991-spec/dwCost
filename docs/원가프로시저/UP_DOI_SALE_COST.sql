		    ...
		    FROM (
		        ...
		        SELECT
		            ...
		            CASE 
		   			...
		   			ELSE 
		                  CASE
		                        WHEN CAST(stco.[OUT] AS BIGINT) * CAST(sale.수량 AS BIGINT) / sale.합계수량 > 2147483647 THEN 2147483647
		                        ELSE CAST(ROUND(CAST(stco.[OUT] AS BIGINT) * CAST(sale.수량 AS BIGINT) * 1.0 / sale.합계수량, 0) AS INT)
		                    END
		            END AS Base_OUT_Qty,
