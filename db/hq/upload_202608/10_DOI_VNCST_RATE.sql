...
DECLARE @before INT = (SELECT COUNT(*) FROM [DOI_VNCST_RATE] WHERE [YYYYMM]='202608' AND [SITE]='HQ' AND [SEL_CODE]='ACTUAL');
DELETE FROM [DOI_VNCST_RATE] WHERE [YYYYMM]='202608' AND [SITE]='HQ' AND [SEL_CODE]='ACTUAL';
...
DECLARE @after INT = (SELECT COUNT(*) FROM [DOI_VNCST_RATE] WHERE [YYYYMM]='202608' AND [SITE]='HQ' AND [SEL_CODE]='ACTUAL');
